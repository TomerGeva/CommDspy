...
from test.test_pattern_coding import coding_gray_test, decoding_gray_test, coding_differential_test, decoding_differential_test, coding_manchester_test, decoding_manchester_test
